...
sub run() {
    ...
    wait_screen_change { type_string $USERNAME. "@" . $DOMAIN . ".com" };
    wait_screen_change { send_key "alt-p" };
    wait_scren_change { type_string $PASSWD };
    send_key "alt-a";
    ...
    wait_screen_change { send_key "alt-a" };
    # wait until account2 online
    # Should have AIM accounts 1 and 2
    assert_screen 'pidgin-aim-account2', 90;
    ...
    wait_screen_change { send_key "ret" };
    wait_screen_change { type_string "hello world!\n" };
